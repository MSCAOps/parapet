...
def serverTask():
    ...
    if form.process().accepted:
        ...
        if len(grid['validHosts']) > 0:
            ...
            taskData = scheduler.queue_task(serverTask,pvars=taskVals,timeout=(60*60)*3,start_time=taskStartTime,stop_time=taskStopTime,period=taskPeriod,repeats=taskRepeats,sync_output=10,task_name=taskName)
