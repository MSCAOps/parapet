...
response.logo = A(B('Parapet'),
                  _class="brand",_href=URL('default','index'))
response.title = request.application.replace('_',' ').title()
response.subtitle = ''

## read more at http://dev.w3.org/html5/markup/meta.name.html
response.meta.author = 'MSCA Operations <msca-operations@sisa.samsung.com>'
response.meta.keywords = 'ansible, python, framework'
...
response.menu = [
    (T('Home'), False, URL('default', 'index'), [
        (T('Manage'), False, URL('default','index'), [
            (T('Accounts'), False, URL('default','manageAccountInfo')),
            (T('Applications'),False,URL('default','manageAppInfo')),
            (T('Playbooks'),False,URL('default','managePbInfo')),
            (T('Tasks'),False,URL('default','manageAppTask'))]),
        (T('View'),False,None,[
